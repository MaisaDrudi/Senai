...
function atualizaPerfil(tipo) {
    ...
    var stack = [];
    for (let i = 0; i < telefones.childElementCount; i++){
        stack.push({'telefone': telefones.children[i].value });
    }
    ...
    dados += "&telefones=" + JSON.stringify(stack);
